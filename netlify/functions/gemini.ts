...
Analyze the user's basketball shooting form.
...
Each value should explain how the user can improve that specific body part.
Do not include scores.
Do not include extra text.
Do not include markdown.
If one value is empty or null, return "Body part not addressed" for that value.
