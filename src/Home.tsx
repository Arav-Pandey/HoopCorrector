...
export default function Home({ setActive }: Props) {
  ...
  return (
    <div className="w-full min-h-[80vh] flex flex-col items-center justify-center py-6 px-4 sm:py-8 text-white">
      <div className="relative w-full overflow-hidden rounded-2xl sm:rounded-[2rem] border border-orange-500/30 bg-slate-900/70 p-4 sm:p-6 lg:p-10 shadow-[0_40px_100px_rgba(0,0,0,0.35)] backdrop-blur-xl">
          ...
          <div className="space-y-6 sm:space-y-8">
              ...
              <div className="relative max-w-2xl" ref={definitionRef}>
                <h1 className="text-2xl sm:text-3xl lg:text-5xl font-extrabold tracking-tight text-white">
                  ...
                  <span className="relative inline-block">
                    <button
                      type="button"
                      onClick={() => setActiveDefinition("form")}
                    ...
                    {activeDefinition === "form" && (
                      <div className="absolute left-1/2 top-full z-10 mt-2 w-60 sm:w-72 -translate-x-1/2 rounded-[1.75rem] border border-white/10 bg-slate-950/95 p-3 sm:p-4 text-xs sm:text-sm text-slate-200 shadow-2xl">
                        ...
                        <p className="mt-2 text-slate-300">
                          Form is your shooting posture and body control — how you position your feet, balance, and deliver the ball consistently.
                        </p>
                      </div>
                    )}
                  </span>{' '}
                ...
                <p className="mt-4 text-sm sm:text-base lg:text-lg leading-7 sm:leading-8 text-slate-300">
                  HoopCorrector brings a premium basketball training experience to your browser. Improve your shooting with intelligent body alignment analysis, ball trajectory insights, and easy-to-follow feedback tailored for every player.
                </p>
              </div>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 shadow-[0_12px_45px_rgba(255,140,0,0.08)]">
                <p className="text-xs sm:text-sm uppercase tracking-[0.22em] text-orange-300">Focus</p>
              ...
              <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-5 shadow-[0_12px_45px_rgba(255,140,0,0.08)]">
                <p className="text-xs sm:text-sm uppercase tracking-[0.22em] text-orange-300">Experience</p>
                <p className="mt-3 text-sm sm:text-base leading-6 sm:leading-7 text-slate-200">
                  A polished training hub built for modern players and fast improvement.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-start gap-3 sm:gap-4 sm:flex-row sm:items-center">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-full bg-gradient-to-r from-orange-500 to-amber-400 px-6 sm:px-7 py-3 sm:py-4 text-sm sm:text-base font-semibold text-slate-950 shadow-lg shadow-orange-500/25 transition hover:scale-[1.01] hover:brightness-110 active:scale-95"
              >
                Get Started
              </button>
              <button
                onClick={() => setActive("FormHome")}
                className="w-full sm:w-auto inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-6 sm:px-6 py-3 sm:py-4 text-sm sm:text-base font-semibold text-white transition hover:bg-white/10 active:scale-95"
              >
                Explore Form Analysis
              </button>
            </div>
          </div>

          <div className="relative hidden lg:flex items-center justify-center">
            <div className="absolute -inset-4 rounded-[2rem] bg-gradient-to-br from-orange-500/25 via-transparent to-slate-900/20 blur-3xl" />
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/80 p-4 sm:p-6 shadow-xl">
              <img src={Basketball} alt="Basketball illustration" className="relative mx-auto h-48 sm:h-60 lg:h-72 w-48 sm:w-60 lg:w-72 object-contain" />
              <div className="mt-4 sm:mt-6 rounded-2xl sm:rounded-3xl bg-slate-900/85 p-3 sm:p-4 text-xs sm:text-sm text-slate-300 ring-1 ring-white/10">
                <p className="font-semibold text-white">Start your shot review</p>
                <p className="mt-2 text-slate-400">
                  Tap “Get Started” to record a shot, then choose whether you want form or arc feedback.
                </p>
              </div>
            </div>
          </div>
        ...
        {[
          {
            ...
            description: "Capture your shot and get actionable feedback in seconds.",
          },
          {
          ...
          <div key={item.label} className="rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-900/80 p-4 sm:p-5 text-left shadow-[0_18px_50px_rgba(0,0,0,0.2)] transition hover:-translate-y-1 hover:border-orange-400/50 hover:bg-slate-900/95">
            <p className="text-xs sm:text-sm uppercase tracking-[0.24em] text-orange-300">{item.label}</p>
            <p className="mt-3 text-sm sm:text-base leading-6 sm:leading-7 text-slate-300">{item.description}</p>
          </div>
        ))}
      </div>
    </div>
