  ...
  return (
    <div className="flex flex-col items-center w-full px-4 sm:px-6 py-6 sm:py-8">
      ...
      <button
        ...
        className="mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 bg-linear-to-r from-orange-500 to-amber-400 text-slate-950 text-sm sm:text-base font-semibold rounded-lg shadow-lg shadow-orange-500/25 hover:scale-[1.02] hover:brightness-110 transition active:scale-95"
      >
        Rewatch Feedback
      </button>
